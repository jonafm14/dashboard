...
export async function getSizeType (pageNumber = 0, pageSize = 10, sortField = null, sortOrder = null) {
  let endpoint = `/size-type/list-size-type?user=SYSTEM&pageNumber=${pageNumber}&pageSize=${pageSize}`
